        ...
        <div>
            <Container>
                <div className="d-flex">
                    ...
                    <div>
                        <Link to={"/visualizarservico"} className="btn btn-outline-primary btn-sm m-1">Listar</Link>
                        <Link to={"/servico/" + id} className="btn btn-outline-primary btn-sm">Consultar</Link>
                    </div>
                </div>
                <hr className="m-1" />
                ...
                <Form className="p-2" onSubmit={edtServico}>
                    ...
                    {status.formSave ? <Button type="submit" outline color="warning" className="m-1" disabled>Salvando...<Spinner size="sm" color="warning" /></Button> :
                        <Button type="submit" outline color="info" className="m-1">Salvar</Button>}
